...
void AffManager::goHomeNoHandsExe()
{
    ...
    if (robot== "icubSim")    {
        ...
        orH = dcm2axis(R2);     // from rotation matrix back to the axis/angle notation
...
void AffManager::simTool(int toolI,int orDeg )
{
    ...
    //fprintf(stdout,"M = \n[ %s ] \n\n", R.toString().c_str());
    od = dcm2axis(R);     // from rotation matrix back to the axis/angle notation
