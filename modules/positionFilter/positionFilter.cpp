...
/** 
\defgroup positionFilter facilitates interaction with tracker
...
- \e /positionFilter/img:i        Port receiving images to propagate or prepare the template
- \e /positionFilter/coords:i     Port to receive coordinates from user-yarpview/out to define Bounding Box for template or 2D coordinates
- \e /positionFilter/track:i      Port to receive coordinates from tracker to get object 2D or 3D location
- \e /positionFilter/coords:o     Port to send computed object coordinates
- \e /positionFilter/imgOut:o     Port sending images on the frames when the objects location is computed
- \e /positionFilter/crop:o       Port to send croped image for template
...
/************************************************************************/
class PositionFilter: public RFModule
{
protected:
